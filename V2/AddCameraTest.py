...
def AddCameraTest (TestID, GuidTest, Camera1):
    ...
    try:
        ...
        # Create a new record
            ...
            sql = "INSERT INTO `CameraSummary` (`TestID`, `GuidTest`, `Camera`, `IdCam`, `HardwareName`, `CameraUse`, `IpCameraAddress`,  `SnapshotUrl`,  `VideoUrl`,  `Description`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
            cursor.execute(sql, (TestID, GuidTest, Cam, IdCam, HardwareName, CameraUse, IpCameraAddress, SnapshotUrl, VideoUrl, Description))
