...
def AnalysisLogFaceAnalysis (TestID, GuidTest, CountTest):

    print ("********************************************")
    print ("******************************************************")
    print ("          Inicio de Analisis del Log (took)")
    print ("            (Face Analysis Function)")
    print ("******************************************************")
    print ("********************************************")
    ...
    for file in dirs:
        ...
        for ClientLine in lineas_texto:
            ...
            if parametro in ClientLine:
                ...
                AddLogFuntionTook (TestID, GuidTest, CountTest, Timeline, InfoLog, TookTime)
